...
/*Monetbil::setServiceKey(env('MONETBIL_KEY'));
Monetbil::setServiceSecret(env('MONETBIL_SECRET'));
Monetbil::setWidgetVersion(env('MONETBIL_VERSION'));
*/
Monetbil::setServiceKey('kTcr8yJPge7ZYirWGSTH6OVIWVTXwa7S');
Monetbil::setServiceSecret('7HCKdxHX35xuqFlmpWPXpw1X5hL4nygmitFK0jdUP4wRCYJSmqx81QUcCbe24MH2');
